...
// Puntos de interés en Milán
const touristSpots = [
  {
    name: "Duomo di Milano",
    coords: [45.4641, 9.1919],
    color: "red",
    description: "Catedral gótica icónica de Milán"
  },
  {
    name: "Galleria Vittorio Emanuele II",
    coords: [45.4659, 9.1900],
    color: "blue",
    description: "Centro comercial histórico con arquitectura impresionante"
  },
  {
    name: "Teatro alla Scala",
    coords: [45.4675, 9.1892],
    color: "green",
  ...
  if (process.client) {
    ...
    setTimeout(async () => {
      try {
        ...
        const map = L.map(mapContainer.value).setView([45.4658, 9.1904], 16);
    ...
    }, 1500); // Simular carga - reducir o eliminar en producción
  }
});
</script>
