    ...
    <div class="flex flex-row relative bg-gray-800 text-white text-2xl tracking-wider font-bold rounded-t-lg p-4 w-full">
        ...
        <div class="absolute right-4 top-.5">
            <button id="close-form" class="text-2xl text-gray-600 font-bold hover:text-red-600">
                <img src="<?php echo e(asset('icons/close_icon.svg')); ?>" alt="Cerrar"
                    class="w-8 h-8 duration-300 hover:rotate-180">
            </button>
        </div>
    </div>
    <form action="<?php echo e(route('countries.store')); ?>" method="POST" class="space-y-6 p-8">
        <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/resources/views/admin/country-register.blade.php ENDPATH**/ ?>